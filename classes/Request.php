...
class Request
{
    ...
    public static function Setup()
    {
        if( !self::$setup )
        {
            ...
            {
                $_GET = OwnString::RemoveSlashes($_GET);
                $_POST = OwnString::RemoveSlashes($_POST);
                $_COOKIE = OwnString::RemoveSlashes($_COOKIE);
            }

            $_REQUEST = array_map(array('OwnString', 'Trim'), array_merge($_GET, $_POST));
        }
    }
    ...
    public static function GetSafe($name)
    {
        ...
        {
            return OwnString::HtmlSpecialChars($_REQUEST[$name]);
        }
